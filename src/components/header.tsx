...
const headerStyles = tv({
  slots: {
    header:
      "w-full flex items-center justify-between py-4 px-10 bg-white max-w-[1440px] fixed border-b border-zinc-100 z-10",
...
const { header, list, listItem, navItem, dropdown, dropdownItem } =
  headerStyles();
    ...
    <header className={header()}>
      ...
      <nav>
        <ul className={list()}>
          ...
          <li>
            <a className={navItem()} href="#addresses">
              Onde estamos
            </a>
          </li>
          <li>
            <a className={navItem()} href="whoiam">
              Quem somos
            </a>
          </li>
        </ul>
